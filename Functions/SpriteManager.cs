...
namespace CreativePlayers.Functions
{
    public class SpriteManager : MonoBehaviour
    {
        ...
        public static SpriteManager Instance
        {
            get
            {
                if (!GameObject.Find("PlayerSpriteManager"))
                {
                    GameObject spr = new GameObject("PlayerSpriteManager");
                    return spr.AddComponent<SpriteManager>();
                }
                else
                {
                    return GameObject.Find("PlayerSpriteManager").GetComponent<SpriteManager>();
                }
            }
        }
